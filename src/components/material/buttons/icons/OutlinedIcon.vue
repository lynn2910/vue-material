<template>
  <button
    ...
    class="btn_after relative flex flex-row items-center justify-center w-12 h-12 gap-x-2 p-2.5 rounded-[6.25em] shadow-lg text-sm tracking-[.00714em] font-medium select-none border border-on-surface-variant/70"
    :class="{
